...
const getDefualtNews = async (req, res) => {
  try {
    const response = await axios.get(
      "https://newsapi.org/v2/everything?q=bitcoin&apiKey=0d6ca64f4de64f0a83cf4ee85d24aafc"
    );
...
const getNewsBySearch = async (req, res) => {
  ...
  try {
    const response = await axios.get(
      "https://newsapi.org/v2/everything?q=Prisoner Swaps&from=2024-08-01&sortBy=popularity&apiKey=0d6ca64f4de64f0a83cf4ee85d24aafc"
      // {
      //   params: {
